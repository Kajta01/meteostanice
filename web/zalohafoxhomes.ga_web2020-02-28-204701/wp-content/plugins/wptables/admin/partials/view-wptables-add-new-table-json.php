...
<input id="input-type" type="hidden" name="input-type-json">
<div id="wpt-tab-file" class="wpt-tab-content">
    <div id="wpt-error-file-wrong-type" class="wpt-notice wpt-notice-error" style="display: none;">
        <p>
            <?= __('Wrong file type. Please select JSON file.', 'wptables') ?>
        </p>
    </div>
    <div id="wpt-drop-zone" class="wpt-upload-drop-zone">
        <input id="wpt-file-upload" name="json-data-file" type="file" accept="application/json" />
...
<div id="wpt-tab-url" class="wpt-tab-content wpt-wrap">
    ...
    <input id="wpt-input-url" type="text" name="json-data-url" class="large-text" />
</div>
<div id="wpt-tab-copy" class="wpt-tab-content wpt-wrap">
    <div class="wpt-form-label"><?= __('Copy/paste data', 'wptables') ?>:</div>
    <textarea id="wpt-input-copy" class="large-text wpt-code" rows="8" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" name="json-data-text"></textarea>
</div>
