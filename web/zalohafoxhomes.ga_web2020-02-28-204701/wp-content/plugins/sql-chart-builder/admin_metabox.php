...
<h4 style="margin-top:0px">Choose a chart type</h4>
...
<p style="text-align: right;font-weight:bold">Need dedicated support with building custom SQL reports or customizing under your own needs? <a target="_blank" href="https://guaven.com/contact/solution-request/">Contact us.</a></p>
<hr>

<h4>Dynamic filters  </h4>
<p>Using this section you can create dynamic variables inside SQL code. It also creates corresponding dynamic input form above each chart.  <a class="btn button dynamicfieldbutton">Show/Hide</a></p>
<script>
...
<br><p>Use this format: <i>variable_name~default_value~variable_label~variable_type | variable_name~default_value~variable_label~variable_type</i> etc.<br>
  ...
  For example if to put <b>limit_tag:10:Count:number | post_date_tag:2010-07-05 17:25:18_Date Published_date</b> here,
...
<p><label><input type="checkbox" name="guaven_sqlcharts_formpartrole" value="1"
  ...
  <p>See working <a href="https://www.dropbox.com/s/6xa6gk7uc75b8me/mysqlchart_example-2.png?dl=0" target="_blank">example</a><br>
    See its <a href="https://www.dropbox.com/s/fq1gnqcqdbj65ch/mysqlchart_example-3.png?dl=0" target="_blank">result</a>
  </p>
</div>
...
<h4>Arguments and Values - See <a href="https://www.dropbox.com/s/5tt0se24x6hfas0/mysqlchart_example-1.png?dl=0" target="_blank">Example 1</a>
